...
newLink.textContent= "New Feature";

const linkSeven = document. querySelector('nav');
linkSeven.prepend(newLink);
...
const secondBtn = document. querySelector("section.cta > div");
secondBtn.appendChild(newButton);
...
var contactHeader = document.querySelector("section.conatct > h4");
var contactAdresss = document.querySelector("section.conatct > p:nth-child(2)");
var contactNumber = document.querySelector("section.conatct > p:nth-child(3)");
var contactEmail = document.querySelector("section.conatct > p:nth-child(4)");


contactHeader.textContent = siteContent ["contact"]["contact-h4"];
contactAdresss.textContent = siteContent ["contact"]["address"];
